...
export const testimonials: Testimonial[] = [
  ...
  {
    id: "t2",
    text: "I called them when my fridge suddenly stopped cooling, and they showed up within a few hours. The technician was professional, explained everything.",
    name: "James K.",
    location: "Parma, OH",
     image:"/images/jobs/job-1.png"
  },
  {
    id: "t3",
    text: "I called them when my fridge suddenly stopped cooling, and they showed up within a few hours.",
    name: "Linda R.",
