...
export const STEPS: Step[] = [
  {
    ...
    description:
      "Getting started is quick and easy. You can reach out to us by phone, email, or through our online booking form. Once we receive your request, we schedule a convenient appointment.",
  },
  {
    id: "diagnosis",
    title: "Diagnosis & Quote",
    description:
      "Our certified technician will arrive at your location on time, fully equipped with the tools and knowledge to assess your appliance and provide a transparent upfront quote.",
  },
  {
    id: "repair",
