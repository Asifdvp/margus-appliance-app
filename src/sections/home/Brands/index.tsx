...
export function Brands() {
  return (
    <section className="py-12 bg-white">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-[4.7fr_7.3fr] gap-8 items-center">
          <div>
            ...
            <p className="font-manrope font-normal text-[14px] leading-5.5 text-[#535756] lg:text-[18px] lg:leading-7">
